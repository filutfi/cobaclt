...
/**
 * SosmedController implements the CRUD actions for TbSosmed model.
 */
class SosmedController extends Controller
{
    ...
    /**
     * Displays a single TbSosmed model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing TbSosmed model.
    ...
    /**
     * Deletes an existing TbSosmed model.
    ...
    /**
     * Finds the TbSosmed model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TbSosmed the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TbSosmed::findOne($id)) !== null) {
            return $model;
        } else {
