...
jQuery(document).ready(function($) {
    ...
    $('.contact-form').on('submit', function(e) {
        ...
        var $messageContainer = $form.find('.verso-messages');
    ...
    function showInputMessage(message, status, messageContainer) {
        ...
        messageContainer.append('<div class="alert alert-' + status + ' alert-dismissable fade show" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' + message.message + '</div>');
    }
});
